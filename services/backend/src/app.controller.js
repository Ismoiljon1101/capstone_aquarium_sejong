...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.getServiceHealth = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.appService.getServiceHealth()];
    ...
    (function () {
        ...
        _getServiceHealth_decorators = [(0, common_1.Get)('health/services')];
