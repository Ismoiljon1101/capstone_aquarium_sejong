...
var ScheduleDto = function () {
    ...
    return _a = /** @class */ (function () {
            function ScheduleDto() {
                this.cronExpression = __runInitializers(this, _cronExpression_initializers, void 0);
                this.label = (__runInitializers(this, _cronExpression_extraInitializers), __runInitializers(this, _label_initializers, void 0));
        ...
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _cronExpression_decorators = [(0, class_validator_1.IsOptional)()];
            _label_decorators = [(0, class_validator_1.IsOptional)()];
...
var LegacyController = function () {
    ...
    var _triggerFeed_decorators;
    var _setSchedule_decorators;
    var LegacyController = _classThis = /** @class */ (function () {
        function LegacyController_1(sensorsService, actuatorsService) {
            ...
            this.logger = new common_1.Logger(LegacyController.name);
        }
        LegacyController_1.prototype.getHistory = function (range) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.sensorsService.getHistory(1, range || '24h')];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        LegacyController_1.prototype.getLatest = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.sensorsService.getLatest()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        LegacyController_1.prototype.getStatus = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, { status: 'online', service: 'backend', version: '2.0.0-monorepo' }];
                });
            });
        };
        LegacyController_1.prototype.triggerFeed = function (_body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        LegacyController_1.prototype.setSchedule = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log('Legacy schedule request received');
                    return [2 /*return*/, __assign({ status: 'scheduled' }, body)];
                });
            });
        };
        return LegacyController_1;
    }());
    __setFunctionName(_classThis, "LegacyController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getHistory_decorators = [(0, common_1.Get)('history')];
        _getLatest_decorators = [(0, common_1.Get)('latest')];
        _getStatus_decorators = [(0, common_1.Get)('status')];
        _triggerFeed_decorators = [(0, common_1.Post)('feed')];
        _setSchedule_decorators = [(0, common_1.Post)('schedule')];
        ...
        __esDecorate(_classThis, null, _triggerFeed_decorators, { kind: "method", name: "triggerFeed", static: false, private: false, access: { has: function (obj) { return "triggerFeed" in obj; }, get: function (obj) { return obj.triggerFeed; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _setSchedule_decorators, { kind: "method", name: "setSchedule", static: false, private: false, access: { has: function (obj) { return "setSchedule" in obj; }, get: function (obj) { return obj.setSchedule; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        LegacyController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LegacyController = _classThis;
}();
