...
var DatabaseService = function () {
    ...
    var DatabaseService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, seed_1.seedDatabase)(this.dataSource)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
         ...
         */
        DatabaseService_1.prototype.getHealth = function () {
            return __awaiter(this, void 0, void 0, function () {
                var isConnected, entities;
                return __generator(this, function (_a) {
                    try {
                        isConnected = this.dataSource.isInitialized;
                        entities = this.dataSource.entityMetadatas.length;
                        this.logger.log("Database health check: ".concat(isConnected ? 'OK' : 'FAIL'));
                        return [2 /*return*/, {
                        ...
                        return [2 /*return*/, { status: 'down', error: error.message }];
                    }
                    return [2 /*return*/];
                });
            });
