...
export const LiveTelemetry: React.FC = () => {
  ...
  const sensors = [
    { label: 'pH Level', value: sensorData?.pH ?? 7.0, unit: 'pH', min: 0, max: 14, type: 'pH' },
    { label: 'Temperature', value: sensorData?.temp_c ?? 25.0, unit: '°C', min: 20, max: 35, type: 'temp_c' },
    { label: 'Dissolved Oxygen', value: sensorData?.do_mg_l ?? 7.5, unit: 'mg/L', min: 0, max: 12, type: 'do_mg_l' },
  ];
