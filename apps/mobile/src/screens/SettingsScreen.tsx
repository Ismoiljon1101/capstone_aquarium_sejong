    ...
    >
      ...
      >
        <Ionicons
          name={icon}
          size={18}
          color={iconColor ?? (danger ? "#ef4444" : "#38bdf8")}
        />
      </View>
  ...
  return (
    <View
      style={{
        ...
        borderRadius: 16,
        borderWidth: 1,
        borderColor: open ? "rgba(56,189,248,0.18)" : "rgba(255,255,255,0.06)",
        marginBottom: 22,
        overflow: "hidden",
      }}
    >
      ...
      >
        <View
          style={[
            iconBoxStyle,
            open && { backgroundColor: "rgba(56,189,248,0.18)" },
          ]}
        >
          <Ionicons
            name={icon}
...
function RangeRow({
  ...
  return (
    ...
    >
      ...
      <Text
        style={{ flex: 1, fontSize: 14, color: "#e2e8f0", fontWeight: "500" }}
      >
        {label}
      </Text>
    ...
    >
      ...
      <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
        ...
        <TextInput
          ...
          placeholderTextColor="#475569"
        />
        <Text style={{ color: "#94a3b8", fontSize: 12, minWidth: 28 }}>
          {unit}
        </Text>
      </View>
    </View>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={{ flex: 1, minWidth: 0 }}>
          <Text
            style={{ fontSize: 17, fontWeight: "700", color: "#f1f5f9" }}
            numberOfLines={1}
          >
            {profile.name}
          </Text>
      ...
      >
        ...
        {profile.tier !== "premium" && (
          <TouchableOpacity
            onPress={() =>
              Alert.alert("Upgrade", "Plans & billing will open here.")
            }
            activeOpacity={0.85}
            accessibilityRole="button"
...
function TankCard() {
      ...
      <Section title="Tank">
        <View style={{ padding: 16, gap: 14 }}>
          ...
          <View>
            ...
            >
              Found on the bottom of the Fishlinic gateway box. Required to
              receive live data from your tank's hardware.
            </Text>
          </View>
          <View style={{ flexDirection: "row", gap: 10 }}>
            ...
            >
              <Text
                style={{ fontSize: 14, fontWeight: "700", color: "#94a3b8" }}
              >
                Cancel
              </Text>
            </TouchableOpacity>
  ...
  return (
    <Section title="Tank">
      <Row
        icon="cube-outline"
        label={profile.tankName || "My Tank"}
        sub="Tap to rename"
        onPress={() => setEditing(true)}
      ...
      <Row
        ...
        label={
          paired ? `Paired · ${profile.deviceId}` : "Pair Fishlinic gateway"
        }
        sub={
          paired
            ? "Hardware is linked to this account"
            : "Required to control hardware remotely"
        }
      ...
      <Row
        ...
        label="Cloud sync"
        sub="Schedules + alerts available from anywhere"
        last
        right={
          <Switch
            value={profile.cloudSync}
            onValueChange={(v) => {
              Haptics.selectionAsync();
              update({ cloudSync: v });
            }}
            trackColor={{ true: "#0891b2", false: "#1e293b" }}
            thumbColor="#fff"
          />
        }
      />
...
export default function SettingsScreen() {
  ...
  const [tts, setTts] = useState(
    store.get(SETTINGS_KEYS.TTS_ENABLED, "true") === "true",
  );
  const [alertSnd, setAlertSnd] = useState(
    store.get(SETTINGS_KEYS.ALERTS, "true") === "true",
  );
  const [push, setPush] = useState(
    store.get(SETTINGS_KEYS.PUSH, "true") === "true",
  );
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            [
              SETTINGS_KEYS.PH_MIN,
              SETTINGS_KEYS.PH_MAX,
              SETTINGS_KEYS.TEMP_MIN,
              SETTINGS_KEYS.TEMP_MAX,
              SETTINGS_KEYS.DO2_MIN,
              SETTINGS_KEYS.DO2_MAX,
              SETTINGS_KEYS.CO2_MAX,
      ...
      >
        ...
        <Section title="Notifications">
            ...
            right={
              <Switch
                ...
                onValueChange={(v) => {
                  Haptics.selectionAsync();
                  setAlertSnd(v);
                  store.set(SETTINGS_KEYS.ALERTS, String(v));
                }}
                trackColor={{ true: "#0891b2", false: "#1e293b" }}
                thumbColor="#fff"
              />
          ...
          <Row
            ...
            label="Veronica voice"
            sub="AI assistant speaks her replies aloud"
            last
            right={
              <Switch
                value={tts}
                onValueChange={(v) => {
                  Haptics.selectionAsync();
                  setTts(v);
                  store.set(SETTINGS_KEYS.TTS_ENABLED, String(v));
                }}
                trackColor={{ true: "#0891b2", false: "#1e293b" }}
                thumbColor="#fff"
              />
        ...
        >
          <RangeRow
            ...
            label="pH"
            unit="pH"
            minKey={SETTINGS_KEYS.PH_MIN}
            maxKey={SETTINGS_KEYS.PH_MAX}
          />
          <RangeRow
            icon="thermometer-outline"
            label="Temperature"
            unit="°C"
            minKey={SETTINGS_KEYS.TEMP_MIN}
            maxKey={SETTINGS_KEYS.TEMP_MAX}
          />
          <RangeRow
            icon="water-outline"
            label="Dissolved O₂"
            unit="mg/L"
            minKey={SETTINGS_KEYS.DO2_MIN}
            maxKey={SETTINGS_KEYS.DO2_MAX}
          />
          <SingleRangeRow
            icon="cloud-outline"
            label="CO₂"
            unit="ppm"
            maxKey={SETTINGS_KEYS.CO2_MAX}
            last
          />
          <View
            style={{
          ...
          >
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              accessibilityRole="button"
              accessibilityLabel="Reset ranges"
              style={{
                paddingVertical: 10,
                alignItems: "center",
                borderRadius: 8,
            ...
            >
              <Text
                style={{ fontSize: 13, fontWeight: "700", color: "#f87171" }}
              >
                Reset to defaults
              </Text>
            </TouchableOpacity>
        ...
        >
            ...
            <View style={{ flexDirection: "row", gap: 8 }}>
              <TextInput
                ...
                style={{
                  ...
                  color: "#e2e8f0",
                  borderWidth: 1,
                  borderColor: urlDirty ? "#0891b2" : "rgba(255,255,255,0.08)",
                }}
          ...
          <Row
            icon="cloud-outline"
            label="Backend"
            sub="NestJS · port 3000"
            right={<StatusBadge status={backendStatus} />}
          />
          <Row
            icon="wifi-outline"
          ...
          <Row
            ...
            label="Veronica AI"
            sub={llmModel || llmProvider || "Language model"}
            right={<StatusBadge status={llmStatus} />}
          />
          <Row
            icon="analytics-outline"
            label="AI Predictor"
            sub="RF · YOLO · ConvLSTM-VAE"
            right={<StatusBadge status={predictorStatus} />}
          />
          <Row
        ...
        <Section title="About">
          <Row
            icon="fish-outline"
            label="Fishlinic Mobile"
            right={
              <Text style={{ fontSize: 13, color: "#94a3b8" }}>v1.0.0</Text>
            }
          />
          <Row
            icon="school-outline"
